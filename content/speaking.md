...
Nesta sessão, vou compartilhar como usei o AWS Amplify para parar de procrastinar e finalmente criar uma plataforma para compartilhar conteúdo voltado a ajudar mulheres e iniciantes em tecnologia.\
Vamos explorar como o Amplify facilita a implantação de aplicações frontend, conectar a fontes de dados em tempo real e escalar de forma simples. E o melhor? Tudo isso sem precisar de um conhecimento profundo em nuvem.\
...
Research shows that 94% of all companies worldwide use cloud computing at some level, and this number continues to grow. So, whether you're looking to launch a career in cloud technology or expand your skills, you're on the right track.\
...
Once you step into the world of tech, the cloud is inevitable!\
As a software developer, chances are you'll need to deal with cloud technologies at some point in your journey.\
...
We'll cover must-know services for junior developers, including S3 - Cloud Object Storage, AWS Lambda, and API Gateway, giving you a foundation to begin your cloud journey.\
...
An inspiring and hands-on session designed to empower women in the cloud industry!\
We'll dive into practical strategies for fostering diversity, creating inclusive spaces, and closing the gender gap in tech. Together, we'll explore ways to break barriers, amplify voices, and drive meaningful change.\
Expect insights on public speaking, content creation, organizing user groups, and building strong professional networks. Whether you're just starting or a seasoned pro, this workshop is packed with actionable takeaways to help you grow, connect, and make an impact.\
Let's learn, share, and uplift each other because the cloud needs all of us!\
...
**Available for:** conference talks, workshops, panels, fireside chats.\
